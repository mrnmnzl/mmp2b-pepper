...
var TargetBar = (function () {
    ...
    _createClass(TargetBar, [{
        ...
        value: function setTrackerView() {
            ...
            if (this.mode === false) {
                if (this.currentPercentage < 0.5) $(".progress-bar-internal").css("background", "green");else $(".progress-bar-internal").css("background", "red");
            } else {
                if (this.currentPercentage < 0.5) $(".progress-bar-internal").css("background", "red");else $(".progress-bar-internal").css("background", "green");
            }
        }
    }, {
        key: "addProgress",
