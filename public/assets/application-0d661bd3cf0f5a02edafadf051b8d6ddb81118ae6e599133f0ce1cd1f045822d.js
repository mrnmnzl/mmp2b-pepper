...
var ProgressBar = (function () {
    ...
    _createClass(ProgressBar, [{
        ...
        value: function setTrackerView() {
            ...
            if (this.currentPercentage > 0.05) progressBar.width(this.currentPercentage * maxWidth);else progressBar.width(0.05 * maxWidth);
        }
    }, {
        key: "addProgress",
        value: function addProgress() {
...
var TodoList = function TodoList(id, title, deadline) {
